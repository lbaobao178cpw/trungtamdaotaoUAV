...
export default function FormsManager() {
    ...
    const handleFileUpload = async (e) => {
        ...
        try {
            ...
            formDataCloud.append('upload_preset', 'uav_forms');

            const res = await fetch('https://api.cloudinary.com/v1_1/dqxvdhsoa/auto/upload', {
                method: 'POST',
                body: formDataCloud
            });
            ...
            if (data.secure_url) {
                setFormData(prev => ({
                    ...
                    file_size: Math.round(data.bytes / 1024), // KB
