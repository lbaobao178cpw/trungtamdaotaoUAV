...
export default function DisplaySettingsManager() {
  ...
  return (
    <div className="split-layout">
      ...
      {/* MAIN CONTENT */}
      <main className="panel" style={{ display: 'flex', flexDirection: 'column', minHeight: '600px' }}>
        {message && (
          <div style={{
            padding: '12px 15px',
            margin: '15px',
          ...
          <div style={{ display: 'flex', flexDirection: 'column', flex: 1 }}>
            <div className="panel-header">
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%' }}>
                <h2 style={{ margin: 0, fontSize: '1.5rem', fontWeight: 'bold' }}>Quản lý Chính sách & Điều khoản</h2>
                <button
