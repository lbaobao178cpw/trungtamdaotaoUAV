...
export default function StudyMaterialsManager() {
    ...
    const handleFileUpload = async (e) => {
        ...
        try {
            ...
            console.log('🚀 Uploading to Cloudinary with file:', file.name);
            ...
            if (data.success) {
                ...
                setFormData(prev => ({
                    ...prev,
                    file_url: data.url,
                    displayName: data.displayName || file.name
                }));
    ...
    const handleEdit = (material) => {
        ...
        setUploadedFileName(material.title);
                ...
                <table style={{
                    ...
                    <thead>
                        <tr style={{ background: '#f5f5f5', borderBottom: '2px solid #ddd' }}>
                            <th style={{ padding: '12px 16px', textAlign: 'center', fontWeight: '600', width: '40px' }}>
                                <input
                                    type="checkbox"
                                    checked={selectedItems.size > 0 && selectedItems.size === materials.length}
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div style={{ marginBottom: '20px' }}>
                                ...
                                >
                                    ...
                                    <FileDown size={32} style={{ color: '#0066cc', marginBottom: '8px' }} />
                                    <p style={{ margin: '0 0 4px 0', fontWeight: '600', color: '#0066cc' }}>
                                        {uploading ? 'Đang upload...' : 'Click để chọn file hoặc kéo thả'}
                                    </p>
