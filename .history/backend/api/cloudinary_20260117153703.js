...
router.post('/upload', verifyToken, upload.single('file'), async (req, res) => {
  try {
    ...
    // Get original filename with UTF-8 encoding
    ...
    res.json({
      ...
      originalFilename: req.file.originalname, // Tên file gốc từ request
      displayName: req.file.originalname // Tên hiển thị cho download
    });
  } catch (err) {
