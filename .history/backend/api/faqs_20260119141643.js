...
router.post('/', verifyAdmin, async (req, res) => {
    try {
        const { question, answer, category = 'general', display_order = 0, is_active = 1 } = req.body;
       ...
       VALUES (?, ?, ?, ?, ?)`,
            [question.trim(), answer.trim(), category.trim() || 'general', display_order, is_active ? 1 : 0]
        );
