...
router.put("/authorities/:id", async (req, res) => {
  try {
    ...
    contact_email = normalizeStr(contact_email);
    contact_phone = normalizeStr(contact_phone);
    logo_url = normalizeStr(logo_url);

    parent_id = normalizeInt(parent_id);
    level = normalizeInt(level);
    ...
    // Không cho set parent_id là chính nó
